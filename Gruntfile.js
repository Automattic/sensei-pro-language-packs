...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        baseFileUrl: 'https://translate.wordpress.com/projects/sensei%2Fsensei-pro',
        clean: {
            tmp: "tmp/*"
        }
    });
    ...
    grunt.registerTask( 'default', function () {
        grunt.log.writeln( "############################################### " );
        grunt.log.writeln( "##### Sensei PRO Language Pack Generator ###### " );
        grunt.log.writeln( "############################################### " );
    ...
    grunt.registerTask('build', function (version) {
        ...
        fetch('https://translate.wordpress.com/api/projects/sensei/sensei-pro/')
